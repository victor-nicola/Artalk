...
import { FlatList, StyleSheet, SafeAreaView, useWindowDimensions, TouchableOpacity, View } from "react-native";
    ...
    return (
        <SafeAreaView style = {{flex: 1, backgroundColor: "#111"}} >
            <View style = {styles.LogoBanner} >
                ...
                <View style={{flex: 1}}>
                    <Text style = {{marginLeft: -75 + (30-textSize) * 3, fontSize:textSize, color: "#fff"}}>Followers</Text>
                </View>
            </View>
            <FlatList 
                data = {data}
